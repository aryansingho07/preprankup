                    ...
                    <div className={`space-y-8 transition-all duration-1000 text-center lg:text-left ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                        <div className="space-y-6">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-olive/20 bg-olive/10 text-olive-700 mb-4">
                                ...
                                <span className="text-sm font-bold tracking-tight">SSC Performance Intelligence Layer</span>
                            </div>

                            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-graphite-900 leading-[1.1] tracking-tight">
                                Performance Intelligence for <span className="text-olive">SSC Exams</span>
                                <br />
                                <span className="text-2xl sm:text-3xl lg:text-4xl text-olive/80 mt-2 block font-normal">(SSC परीक्षाओं के लिए परफ़ॉर्मेंस इंटेलिजेंस)</span>
                            </h1>

                            <div className="space-y-4">
                                <p className="text-xl sm:text-2xl text-graphite-700 leading-relaxed max-w-2xl font-medium">
                                    Understand why you lose marks in SSC — and what exactly must change in your next attempt.
                                </p>
                                <p className="text-lg sm:text-xl text-olive-700 font-bold bg-olive/5 py-2 px-4 rounded-xl border-l-4 border-olive inline-block">
                                    समझें कि SSC में आपके नंबर क्यों कटते हैं — और आपके अगले प्रयास में क्या बदलना चाहिए।
                                </p>
                            </div>

                            <div className="space-y-2">
                                <p className="text-lg text-graphite-600 max-w-xl">
                                    Built for serious SSC aspirants who prepare consistently but want clarity — not guesswork.
                                </p>
                                <p className="text-md text-graphite-500 italic">
                                    उन गंभीर SSC अभ्यर्थियों के लिए जो निरंतर तैयारी करते हैं और स्पष्टता चाहते हैं — अनुमान नहीं।
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <Link to="/register">
                                <Button
                                    size="lg"
                                    className="w-full sm:w-auto bg-graphite-900 text-white hover:bg-graphite-800 h-16 px-8 rounded-2xl text-lg font-bold shadow-xl shadow-graphite-900/10 transition-all hover:scale-105 active:scale-95 flex flex-col items-center justify-center"
                                >
                                    <span>Attempt Free SSC Mock Test</span>
                                    <span className="text-xs font-normal opacity-80">(फ्री SSC मॉक टेस्ट दें)</span>
                                </Button>
                            </Link>
                            ...
                            <Button
                                ...
                                className="w-full sm:w-auto border-olive/30 hover:bg-olive/5 h-16 px-8 rounded-2xl text-lg font-bold transition-all hover:scale-105 active:scale-95 flex flex-col items-center justify-center gap-0"
                            >
                                <div className="flex items-center gap-2">
                                    <Play className="w-5 h-5 text-olive fill-olive" />
                                    <span>How PrepRankUp for SSC Works</span>
                                </div>
                                <span className="text-xs font-normal text-olive/70">(देखें PrepRankUp कैसे काम करता है)</span>
                            </Button>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 pt-4">
                            ...
                            <div className="flex items-center gap-2 bg-white/50 px-3 py-1.5 rounded-full border border-black/5">
                                <CheckCircle className="w-5 h-5 text-olive" />
                                <span className="text-sm font-bold text-graphite-600">SSC Pattern Focused</span>
                            </div>
                            <div className="flex items-center gap-2 bg-white/50 px-3 py-1.5 rounded-full border border-black/5">
                                <CheckCircle className="w-5 h-5 text-olive" />
                                <span className="text-sm font-bold text-graphite-600">No False Promises</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
                        <div className="relative animate-float">
                            ...
                            <div className="bg-white/80 backdrop-blur-2xl rounded-[2.5rem] shadow-2xl p-8 border border-white/50 relative overflow-hidden">
                                <div className="absolute inset-0 bg-gradient-to-br from-olive/5 via-transparent to-peach-500/5"></div>
                                ...
                                <div className="relative flex items-center justify-between mb-10">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h3 className="text-lg font-bold text-graphite-900 leading-tight">SSC Intelligence</h3>
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                        {[
                                            { label: 'Reasoning', value: '48.5', color: 'bg-rose-400' },
                                            { label: 'Quant', value: '44.0', color: 'bg-olive' },
                                            { label: 'English', value: '46.5', color: 'bg-blue-400' },
                                            { label: 'GK/GS', value: '32.0', color: 'bg-graphite-600' }
                                        ].map((item) => (
                                    ...
                                    <div className="p-6 bg-graphite-900 rounded-[2rem] text-white shadow-xl relative overflow-hidden group">
                                        ...
                                        <div className="relative flex items-start gap-4">
                                            ...
                                            <div>
                                                <p className="text-sm font-bold text-olive-400 mb-1">Time Sink Detected</p>
                                                <p className="text-sm text-white/80 font-medium leading-relaxed">
                                                    You spent 4.2 mins on a single Geometry question.
                                                    <span className="text-white block mt-1 font-bold">Skipping this would have increased your score by 6 marks.</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex justify-between items-end">
                                            <span className="text-xs font-bold text-graphite-500 uppercase">SSC Section Pacing</span>
                                            <span className="text-xs font-bold text-olive">Highly Optimized</span>
                                        </div>
                                        <div className="h-6 w-full bg-graphite-100 rounded-full overflow-hidden flex p-1">
                                            <div className="h-full bg-graphite-900 rounded-full w-[78%] shadow-lg transition-all duration-1000" style={{ transitionDelay: '1000ms' }}></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="absolute -top-6 -right-6 bg-white shadow-2xl rounded-2xl p-4 border border-black/5 animate-bounce-slow">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs font-bold text-graphite-500 uppercase tracking-tighter">Improvement</p>
                                        <p className="text-lg font-bold text-graphite-900">+18 Marks</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <Dialog open={isVideoModalOpen} onOpenChange={handleVideoModal}>
                <DialogContent className="max-w-5xl w-full p-0 bg-black border-none overflow-hidden rounded-[2rem]">
                    <DialogHeader className="sr-only">
                        <DialogTitle>PrepRankUp for SSC Demo</DialogTitle>
                    </DialogHeader>
